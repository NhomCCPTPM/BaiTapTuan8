...
namespace WebDienDanTinTuc.Controllers
{
    public class ThemesController : Controller
    {
        ...
        public ThemesController(WebDienDanTinTucContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ThemeName,Status")] Theme theme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ThemeName,Status")] Theme theme)
        {
            if (id != theme.Id)
            {
                return NotFound();
